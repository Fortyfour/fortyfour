<?php /* Smarty version Smarty 3.1.4, created on 2014-03-03 15:14:09
         compiled from "/var/www/fortyfour/data/www/fortyfour.ru/admin/templates/system/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:51816034153146401b48965-05244840%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fea2e60731a40bcb1986b5c96bdc134391db2b21' => 
    array (
      0 => '/var/www/fortyfour/data/www/fortyfour.ru/admin/templates/system/list.tpl',
      1 => 1393844290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '51816034153146401b48965-05244840',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_531464021e252',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_531464021e252')) {function content_531464021e252($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date')) include '/var/www/fortyfour/data/www/fortyfour.ru/smarty/plugins/modifier.date.php';
if (!is_callable('smarty_modifier_pluralform')) include '/var/www/fortyfour/data/www/fortyfour.ru/smarty/plugins/modifier.pluralform.php';
...
"></span>
                        ...
                        <?php }elseif($_smarty_tpl->tpl_vars['col']->value['type']=='file'){?>
                            <?php if ($_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['col']->value['col_name']]>0){?>
                                <?php $_smarty_tpl->tpl_vars["file"] = new Smarty_variable($_smarty_tpl->tpl_vars['sections']->value->getRowFile($_smarty_tpl->tpl_vars['item']->value['id'],$_smarty_tpl->tpl_vars['main']->value->dataset['params']['table'],$_smarty_tpl->tpl_vars['col']->value['col_name']), null, 0);?>
...
.<?php echo $_smarty_tpl->tpl_vars['file']->value['extension'];?>
                        ...
                        <?php }elseif($_smarty_tpl->tpl_vars['col']->value['type']=='image'){?>
                            <?php if ($_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['col']->value['col_name']]>0){?>
                                <?php $_smarty_tpl->tpl_vars["file"] = new Smarty_variable($_smarty_tpl->tpl_vars['main']->value->getRowImage($_smarty_tpl->tpl_vars['item']->value['id'],$_smarty_tpl->tpl_vars['main']->value->content_list_table,$_smarty_tpl->tpl_vars['col']->value['col_name']), null, 0);?>
...
')"></a>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['main']->value->module_name=='sections'){?>
                    <td>
                        <a href="<?php echo $_smarty_tpl->tpl_vars['main']->value->content_list_copy_link;?>
<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
" class="icon_action icon_copy_instance" title="Копировать запись"></a>
                    </td>
                    <?php }?>
