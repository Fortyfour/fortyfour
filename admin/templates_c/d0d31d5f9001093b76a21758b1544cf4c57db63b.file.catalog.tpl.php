<?php /* Smarty version Smarty 3.1.4, created on 2014-10-30 21:04:08
         compiled from "/home/fortyfour/web/fortyfour.ru/public_html/admin/templates/system/fields_editor/catalog.tpl" */ ?>
<?php /*%%SmartyHeaderCode:162411890754526f88f34ea5-59099135%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd0d31d5f9001093b76a21758b1544cf4c57db63b' => 
    array (
      0 => '/home/fortyfour/web/fortyfour.ru/public_html/admin/templates/system/fields_editor/catalog.tpl',
      1 => 1411668638,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '162411890754526f88f34ea5-59099135',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54526f8912d67',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54526f8912d67')) {function content_54526f8912d67($_smarty_tpl) {?><?php if (!$_smarty_tpl->tpl_vars['default']->value){?>
...
<?php }?>"><?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_label');?>
    			...
    			<td class="content_col">
    				<?php if ($_smarty_tpl->tpl_vars['new']->value){?>
			            <input class="textfield" type="text" value="Каталог" name="label**__**<?php echo $_smarty_tpl->tpl_vars['new']->value;?>
...
<?php }?>" />
        ...
        <input type="hidden" value="catalog" name="type**__**<?php if ($_smarty_tpl->tpl_vars['new']->value){?><?php echo $_smarty_tpl->tpl_vars['new']->value;?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
<?php }?>" />
