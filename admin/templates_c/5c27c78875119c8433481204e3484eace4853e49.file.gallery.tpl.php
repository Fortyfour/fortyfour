<?php /* Smarty version Smarty 3.1.4, created on 2014-10-30 21:03:19
         compiled from "/home/fortyfour/web/fortyfour.ru/public_html/admin/templates/system/fields_editor/gallery.tpl" */ ?>
<?php /*%%SmartyHeaderCode:26090802354526f570556b6-18169106%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5c27c78875119c8433481204e3484eace4853e49' => 
    array (
      0 => '/home/fortyfour/web/fortyfour.ru/public_html/admin/templates/system/fields_editor/gallery.tpl',
      1 => 1411668639,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '26090802354526f570556b6-18169106',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54526f5717ad0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54526f5717ad0')) {function content_54526f5717ad0($_smarty_tpl) {?><?php if (!$_smarty_tpl->tpl_vars['default']->value){?>
...
<?php }?>"><?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_label');?>
    			...
    			<td class="content_col">
    				<?php if ($_smarty_tpl->tpl_vars['new']->value){?>
			            <input class="textfield" type="text" value="<?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_editor_tools_gallery');?>
...
<?php }?>" />
        ...
        <input type="hidden" value="gallery" name="type**__**<?php if ($_smarty_tpl->tpl_vars['new']->value){?><?php echo $_smarty_tpl->tpl_vars['new']->value;?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
<?php }?>" />
