<?php /* Smarty version Smarty 3.1.4, created on 2014-02-27 01:56:41
         compiled from "/Volumes/Black/Users/Ruslan/Sites/fortyfour/admin/templates/system/fields_editor/multiselect.tpl" */ ?>
<?php /*%%SmartyHeaderCode:656977331530e631917a755-62668542%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7eebca3b4f4c8b5e50231a9184cf95cb750b022a' => 
    array (
      0 => '/Volumes/Black/Users/Ruslan/Sites/fortyfour/admin/templates/system/fields_editor/multiselect.tpl',
      1 => 1389258877,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '656977331530e631917a755-62668542',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_530e63198aafc',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_530e63198aafc')) {function content_530e63198aafc($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_substring')) include '/Volumes/Black/Users/Ruslan/Sites/fortyfour/smarty/plugins/modifier.substring.php';
...
<?php }?>"><?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_label');?>
    			...
    			<td class="content_col">
    				<?php if ($_smarty_tpl->tpl_vars['new']->value){?>
			            <input class="textfield" type="text" value="<?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_editor_tools_multiselect');?>
...
<?php }?>"><?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_default');?>
    			...
    			<td class="content_col">
    				<select class="select" multiple="multiple" name="default**__**<?php if ($_smarty_tpl->tpl_vars['new']->value){?><?php echo $_smarty_tpl->tpl_vars['new']->value;?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
...
<?php }?>" />
        ...
        <input type="hidden" value="multiselect" name="type**__**<?php if ($_smarty_tpl->tpl_vars['new']->value){?><?php echo $_smarty_tpl->tpl_vars['new']->value;?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
<?php }?>" />
