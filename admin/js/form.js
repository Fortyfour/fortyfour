...
function initEditor(obj, locale, dom_id){
    ...
    editors[editors_index] = {
        ...
        instance: tinymce.init({
            ...
            plugins : 'advlist autolink link image lists charmap print table hr preview code insertdatetime preview visualblocks visualchars paste searchreplace anchor autoresize link typograph codemirror media moxiecut',
            toolbar: 'undo redo | styleselect | removeformat | pastetext | bold italic strikethrough | bullist numlist | outdent indent | blockquote hr charmap | link insertfile image media | code',
