<?php
    ...
    if($main->module_mode == 'edit'){
        ...
        $main->dataset['data'][12] = array(
            'meta'          => 'work_id',
            'type' 			=> 'select',
            'label' 		=> 'Работа в портфолио',
            'name' 			=> 'content_id',
            'slave_of'      => 'mode',
            'value' 		=> $main->item_data['content_id'],
            'help' 			=> 'Работа в портфолио',
            'section_id'    => 20,
            'options' 		=> $main->parseOptionsFromTable('section_20'),
            'link'          => '/admin/?option=sections&suboption=edit_content&id=20&item=',
            'create_link'   => '/admin/?option=sections&suboption=content&action=create&id=20&structure_link_id=' . $_GET['id'] . '&structure_link_col_id=content_id'
        );
